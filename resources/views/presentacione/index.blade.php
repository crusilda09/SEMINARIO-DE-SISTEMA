                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                            <span class="fw-bolder p-1 rounded bg-danger text-red">Eliminado</span>
                            @endif
                        </td>
                        <td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $presentacion->caracteristica->estado == 1 ? 'Seguro que quieres eliminar esta presentación?' : 'Seguro que quieres restaurar la presentación?' }}
                                </div>
