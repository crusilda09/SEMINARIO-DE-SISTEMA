...
@section('content')
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item actve"> Editar Categoria </li>
                        </ol>
                        <div class="container w-100 border border-3 border-primary rounden p-4 mt-3">
                            <form action="{{ route('categorias.update',['categoria'=>$categoria])}}" method="post">
                                @method('PATCH')
                                @csrf <!--directiva permite enviar formularios-->
                                <div class="row g-3">
                                    <div class="col-md-6"> 
